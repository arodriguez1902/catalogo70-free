<?php
/**
 * Template tarjeta de producto - Versión FREE
 * Variables: $product_id, $fields
 */
...
<div class="codecatalogo-product-card" data-product-id="<?php echo esc_attr($product_id); ?>">
    ...
    <div class="codecatalogo-card-image">
        ...
        <?php if ($categories && !is_wp_error($categories)): ?>
            <div class="codecatalogo-card-badge"><?php echo esc_html($categories[0]->name); ?></div>
        <?php endif; ?>
    </div>
    ...
    <div class="codecatalogo-card-content">
        ...
        <?php if (has_excerpt($product_id)): ?>
            <div class="codecatalogo-card-excerpt"><?php echo esc_html(wp_trim_words(get_the_excerpt($product_id), 15)); ?></div>
        <?php endif; ?>
        <?php if (!empty($fields)): ?>
            <ul class="codecatalogo-card-specs">
                ...
                ?>
                    <li><strong><?php echo esc_html($field->field_label); ?>:</strong> <span><?php echo esc_html($field->field_value); ?></span></li>
